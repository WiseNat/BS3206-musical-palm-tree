...
describe("Add Inventor to Project API", () => {
    describe("AUT003 - An inventor who is already on the project who is added again fails", () => {
        it("TCA009 - Add inventor who is not already on the project", async () => {
            const preProject = await createProject(title, description, language, timezone, programmingLanguage, technology, projectUrl, "OWNER@EMAIL.com");
        ...
        it("TCA010 - Fail to add inventor who is already on the project", async () => {
            ...
            const preProject = await createProject(title, description, language, timezone, programmingLanguage, technology, projectUrl, email);
