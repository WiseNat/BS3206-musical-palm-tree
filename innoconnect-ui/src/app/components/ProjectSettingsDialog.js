          ...
          <DialogContent className="px-4" dividers>
            <Form submitAction={updateProject}>
              <TextField
                ...
                label="Project Title"
                onChange={(e) =>
                  setProject({ ...newProject, title: e.target.value })
                }
                required
              />
              <TextField
                ...
                onChange={(e) =>
                  setProject({ ...newProject, description: e.target.value })
                }
                minRows={3}
                multiline
                required
              />
              <Select
                defaultValue={newProject.mainCommunicationLanguage}
                label="Main Communication Language"
                items={communicationLanguages}
                onChange={(e) =>
                  setProject({ ...newProject, mainCommunicationLanguage: e })
                }
                required
              />
              <Select
                defaultValue={newProject.mainTimezone}
                label="Main Timezone"
                items={timezones}
                onChange={(e) => setProject({ ...newProject, mainTimezone: e })}
                required
              />
              <Select
                defaultValue={newProject.mainProgrammingLanguage}
                label="Main Programming Language"
                items={programmingLanguages}
                onChange={(e) =>
                  setProject({ ...newProject, mainProgrammingLanguage: e })
                }
                required
              />
              <Select
                defaultValue={newProject.mainTechnology}
                label="Main Technology"
                items={technologies}
                onChange={(e) =>
                  setProject({ ...newProject, mainTechnology: e })
                }
                required
              />
              <TextField
                ...
                label="Project URL"
                onChange={(e) =>
                  setProject({ ...newProject, projectUrl: e.target.value })
                }
                required
              />
